...
export default function NavbarIntegrated({ variant = 'transparent' }: NavbarIntegratedProps) {
  ...
  // Collections removed - using WooCommerce instead of Shopify
    ...
    <>
          ...
          <div className="h-20 py-3 flex items-center justify-between relative">
              ...
              {navLinks.slice(0, 2).map((link) => (
                link.hasDropdown ? (
                  <div key={link.text} className="relative" ref={categoriesDropdownRef}>
                    ...
                    {/* Dropdown de categorías - deshabilitado, usando WooCommerce */}
                    {isCategoriesOpen && (
            ...
            <div className="absolute left-1/2 -translate-x-1/2 pointer-events-none">
              <Link href="/" className="pointer-events-auto">
                <div className="flex h-16 w-16 items-center justify-center rounded-full border border-white/20 bg-white/5 text-center">
            ...
            <div className="flex items-center space-x-2 sm:space-x-4 lg:space-x-8">
              ...
              <div className="flex items-center space-x-1 sm:space-x-2 lg:space-x-3">
                ...
                <div className="hidden lg:block">
                  ...
                  >
                    <Link href="/search" className="p-2 rounded-full transition-colors hover:bg-white/20" aria-label="Buscar">
                ...
                {/* Integrar carrito de WooCommerce */}
      ...
      >
        <div className="flex items-center justify-between p-6 border-b">
          <div className="flex h-12 w-12 items-center justify-center rounded-lg border border-gray-200 bg-gray-50 text-sm font-semibold uppercase tracking-[0.15em] text-gray-900">
            STORE
          </div>
          <button
            onClick={() => setIsMobileMenuOpen(false)}
          ...
          {navLinks.map((link, index) => (
            link.hasDropdown ? (
              <div key={link.text}>
                ...
                {/* Submenu de categorías - deshabilitado */}
