    ...
    <div className="bg-white py-10 sm:py-14">
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="font-moderat text-base sm:text-lg text-gray-600 leading-relaxed max-w-2xl mx-auto mb-10">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suscríbete para recibir noticias y actualizaciones de ejemplo.
        </p>
        ...
        <div className="mt-10 mx-auto max-w-xl">
          ...
          <p className="font-moderat text-xs text-gray-500 mt-4 leading-relaxed">
            Al suscribirte, aceptas recibir comunicaciones de ejemplo. Puedes cancelar en cualquier momento.
          </p>
        </div>
      </div>
    </div>
